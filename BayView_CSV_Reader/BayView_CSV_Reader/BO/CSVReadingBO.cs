...
namespace BayView_CSV_Reader
{
    public class CSVReadingBO
    {
        ...
        private const string KIT2_TANK = "KIT2_TANK";
        private const string RO_RO = "RO_RO";
        ...
        #region Fields
        private readonly string[] _headers = { "Date", "B1_TANK", "B2_TANK", "B3_TANK", "B4_TANK", "B5_TANK", "KIT_TANK", "KIT2_TANK", "RO_RO", "RO1_RO", "RO2_RO", "T1_TANK", "T2_TANK", "G1_TANK", "G2_TANK" };
        #endregion
        ...
        #region Publics
        /*
	     * dict<FlatNr, dict<date,List<Reading>>>
	     Collect all CSV
	          Read file one by One
	          get -> flatnr from file name
	    ...
	    */
        ...
        public void CreateReading(string strRootPath)
        {
            ...
            foreach(string strPath in paths)
            {
                ...
                string strFlatNr = strFilename.Substring(0, 3);
                if(!string.IsNullOrEmpty(strFlatNr))
                {
                    ParseCSV(strPath, strFlatNr);
                }
            }
        }
        #endregion
        ...
        #region Privates
        private void ParseCSV(string strPath, string strFlatNr)
        {
            ...
            if(!this.CSV_Info.TryGetValue(strFlatNr, out dictDateReading))
            {
                dictDateReading = new Dictionary<string, Reading>();
                this.CSV_Info.Add(strFlatNr, dictDateReading);
            }
